...
public class ConstNetwork {
    ...
    public static String URLPELANGGAN = "http://103.236.201.231/bukabengkel/api/pelanggan";
    public static String URLANTRIAN = "http://103.236.201.231/bukabengkel/api/antrian";
